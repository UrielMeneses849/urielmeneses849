        ...
        <section className="skills__container" >
            ...
            <div className="contenedorSkillText">
                ...
                <div className="skills__content" style={{backgroundColor: `${fondoCard}`}} onMouseEnter={props.textEnter} onMouseLeave={props.textLeave}>
                    ...
                    <div className="div1"> <img src="https://firebasestorage.googleapis.com/v0/b/portafolio-3302a.appspot.com/o/Iconos%2Freact.svg?alt=media&token=93f30986-31eb-4454-bc49-f1c34d9f9a05" loading="lazy"/></div>
                    <div className="div2"> <img src="https://firebasestorage.googleapis.com/v0/b/portafolio-3302a.appspot.com/o/Iconos%2FCSS%20(2).svg?alt=media&token=9b87d4c8-8dde-459a-b1d2-2d941add9190"  loading="lazy" /></div>
                    <div className="div3"> <img src="https://firebasestorage.googleapis.com/v0/b/portafolio-3302a.appspot.com/o/Iconos%2FMUI.svg?alt=media&token=42e05fca-4ea1-4b8e-98a4-d6662a4dd703"  loading="lazy" /></div>
                    <div className="div4"> <img src="https://firebasestorage.googleapis.com/v0/b/portafolio-3302a.appspot.com/o/Iconos%2FFM.png?alt=media&token=7fb4bf3c-f8de-42a3-bf07-8649de7c9e94"  loading="lazy" /></div>
                    <div className="div5"> <img src="https://firebasestorage.googleapis.com/v0/b/portafolio-3302a.appspot.com/o/Iconos%2Ftailwindcss-icon-svgrepo-com%201.png?alt=media&token=dd4391a3-4bfd-486b-a960-371be12183b0"  loading="lazy" /></div>
            ...
            <div className="contenedorSkillText">
                ...
                <div className="div1"> <img src="https://firebasestorage.googleapis.com/v0/b/portafolio-3302a.appspot.com/o/Iconos%2Fgit.svg?alt=media&token=be1eac56-0c13-4a24-afec-d09cec6349d9"  loading="lazy" /></div>
                <div className="div2"> <img src="https://firebasestorage.googleapis.com/v0/b/portafolio-3302a.appspot.com/o/Iconos%2FDev%20tools.svg?alt=media&token=5e38b6e0-a347-425e-b653-7f74ebae6506"  loading="lazy" /></div>
                <div className="div3"> <img src="https://firebasestorage.googleapis.com/v0/b/portafolio-3302a.appspot.com/o/Iconos%2Fmjml.svg?alt=media&token=a47ec1ad-b337-4edb-8b23-851dbce471e0"  loading="lazy" /></div>
            ...
            <div className="contenedorSkillText">
                ...
                <div className="div1"> <img src="https://firebasestorage.googleapis.com/v0/b/portafolio-3302a.appspot.com/o/Iconos%2Ffigma.svg?alt=media&token=dfddd449-5bb2-482c-ad4c-37dce58c0f99"  loading="lazy" /></div>
                <div className="div2"> <img src="https://firebasestorage.googleapis.com/v0/b/portafolio-3302a.appspot.com/o/Iconos%2Fframer-svgrepo-com.svg?alt=media&token=95bdcd3b-8807-48f4-9a1c-da24b0d7a313"  loading="lazy" /></div>
                <div className="div3"> <img src="https://firebasestorage.googleapis.com/v0/b/portafolio-3302a.appspot.com/o/Iconos%2Fhotjar.svg?alt=media&token=5016c2a3-0bc0-4659-9bc1-e554a2480a1d"  loading="lazy" /></div>
            ...
            <div className="contenedorSkillText">
                ...
                <div className="div1"> <img src="https://firebasestorage.googleapis.com/v0/b/portafolio-3302a.appspot.com/o/Iconos%2Fvite.svg?alt=media&token=7556ec6d-a92d-4f0c-a5b0-5588150346ca"  loading="lazy" /></div>
                {/*  */}
                <div className="div2"> <img src={next} loading="lazy"/></div>
            ...
            <div className="contenedorSkillText">
                ...
                <div className="div1"> <img src={sql}  loading="lazy"/></div>
                <div className="div2"> <img src="https://firebasestorage.googleapis.com/v0/b/portafolio-3302a.appspot.com/o/Iconos%2Fmysql-logo-svgrepo-com.svg?alt=media&token=8e461e0e-100c-4748-a2a2-ee459955799c"  loading="lazy" /></div>
                <div className="div3"> <img src="https://firebasestorage.googleapis.com/v0/b/portafolio-3302a.appspot.com/o/Iconos%2Ffirebase-1-logo-svgrepo-com%20(1).svg?alt=media&token=9aedcee5-fd8a-4322-8f54-aafe840c6cfb"  loading="lazy" /></div>

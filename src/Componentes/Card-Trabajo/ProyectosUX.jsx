...
export default function ProyectosUX(props) {
    ...
    return(
        ...
        <p className="services__modal-description">Design Thinking, investigaciones y KPIs</p>
       ...
       <a href="https://xd.adobe.com/view/e9acc4ba-c43f-4f17-b6a0-bfb464907660-bcff/?fullscreen" target="blank">
        <div className="HC" style={{backgroundImage: `url("https://firebasestorage.googleapis.com/v0/b/portafolio-3302a.appspot.com/o/Maquetas%2FHC.svg?alt=media&token=a8f2e70b-2375-4378-b517-951d204ee0ba")`}}
       onMouseEnter={props.textEnterVisitar} onMouseLeave={props.textLeave}>
        ...
        target="blank"><div className="HC CF" style={{backgroundImage: `url("https://firebasestorage.googleapis.com/v0/b/portafolio-3302a.appspot.com/o/Maquetas%2FCF.svg?alt=media&token=f2aeb3d2-dc63-4e4e-b242-57ff723502f3")`}}
        onMouseEnter={props.textEnterVisitar} onMouseLeave={props.textLeave}>
